    ...
    def post(self, request, *args, **kwargs):
        ...
        for blog in serializer.data:
            ...
            data.append({
                ...
                "linkedin_url": get_user[0]["lickedin_url"],
                "contact_number": get_user[0]["contact_number"],
                "created_at": get_user[0]["created_at"],
                "updated_at": get_user[0]["updated_at"]
            })
...
class SelfBlogListView(ListAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for blog in serializer.data:
            get_user = User.objects.filter(id=blog["user_id"]).values("first_name", "last_name", "email", "description", "linkedin_url", "contact_number")
